...
export class ChallengeController {
    ...
    async createChallenge(req: Request, res: Response) {
        ...
        // Si tu as un middleware d'auth qui injecte req.user
    ...
    async getAllChallenges(req: Request, res: Response) {
        ...
        if (req.query.duration_min || req.query.duration_max) {
            ...
            if (req.query.duration_min)
                filters.durationMinutes.$gte = Number(req.query.duration_min);
            if (req.query.duration_max)
                filters.durationMinutes.$lte = Number(req.query.duration_max);
        }
    ...
    async updateChallenge(req: Request<{id: string}>, res: Response) {
        const id = req.params.id;
        const challenge = req.body as Partial<Challenge>;
